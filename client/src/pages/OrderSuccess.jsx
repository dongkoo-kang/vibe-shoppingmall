...
function OrderSuccess() {
    ...
    return (
      <div className="order-success-page">
        <div className="order-success-container">
          <div className="order-success-loading">주문 정보를 불러오는 중입니다...</div>
        </div>
      </div>
    );
  }
  ...
  if (error) {
    return (
      <div className="order-success-page">
        <div className="order-success-container">
          <div className="order-success-error">{error}</div>
    ...
    <div className="order-success-page">
      <div className="order-success-container">
        <div className="order-success-header">
          <h1 className="order-success-title">주문이 성공적으로 완료되었습니다!</h1>
          <p className="order-success-subtitle">주문해 주셔서 감사합니다.</p>
          <p className="order-success-subtitle">주문 확인 이메일을 곧 받으실 수 있습니다.</p>
          <div className="order-success-icon">✔</div>
        </div>

        <div className="order-success-content">
          <section className="order-section">
            <h2 className="order-section-title">주문 정보</h2>
